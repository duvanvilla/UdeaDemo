...
import com.co.ude.mintic.UdeaDemo.Services.ServicePersona;
import com.co.ude.mintic.UdeaDemo.Util.UtilidadesComunes;
...
@Api (tags = "Persona", description = "Métodos para el API Persona")
@RestController
...
public class ControllerPersona {
    ...
    La anotación @Autowired requiere que la clase que se va a anotar
    ...
    */
    ...
    public ArrayList<String> doWhileController(){
    ...
    public ResponseEntity<Persona> actualizarPersonaParcial (@RequestParam int id, String apellidoModificado){
        System.out.println("- Ingresó al método actualizarPersonaParcial del Controller");
        /*
        String retorno = "Actualizar Persona Parcial";
        new ResponseEntity<Persona>(retorno, HttpStatus.OK);
        */
        Persona p = servicePersona.buscarPersona(id);
